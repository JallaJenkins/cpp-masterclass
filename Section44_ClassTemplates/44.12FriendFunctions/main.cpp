...
// template<typename T>
// class TemplateClass;  // class template forward decl to make func decl possible

// template<typename T>
// void some_func(TemplateClass<T> param); // function template declaration
...
public:
  ...
  void do_something(const T a, T b) {
    std::cout << "Doing something with " << a << " and " << b << '\n';
  }
