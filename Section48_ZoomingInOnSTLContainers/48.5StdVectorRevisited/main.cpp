...
int main(){
  ...
  std::cout << "*it_item_pos: " << *it_item_pos << '\n';
  items.emplace(it_item_pos,45,10); // The parameters following the iterator
  // items.emplace(it_item_pos,Item(45,10)); // The parameters following the iterator
                                      // are passed to a constructor of the type stored in 
                                      // the vector.
  print_collection(items);
  std::cout << "*it__item_pos: " << *it_item_pos << '\n';
