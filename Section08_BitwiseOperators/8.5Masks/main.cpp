...
int main(){
  ...
  std::cout << std::setw(COLUMN_WIDTH) << std::bitset<8>(var);
  std::cout << std::endl;
  ...
  std::cout << "Resetting bits at pos 0, 2, 4, 6" << std::endl;
  ...
  std::cout << "Checking the state of each bit position (on/off)" << std::endl;
	std::cout << "bit0 is " << sizeof((var & mask_bit_0) >> 0 )<< std::endl;
  ...
  std::cout << "Toggle bit at pos 0" << std::endl;
  var ^= mask_bit_0;
  std::cout << std::setw(COLUMN_WIDTH) << "var: ";
  std::cout << std::setw(COLUMN_WIDTH) << std::bitset<8>(var);
  std::cout << std::endl;

  std::cout << "Toggle bit at pos 7" << std::endl;
  var ^= mask_bit_7;
  std::cout << std::setw(COLUMN_WIDTH) << "var: ";
  std::cout << std::setw(COLUMN_WIDTH) << std::bitset<8>(var);
  std::cout << std::endl;

  std::cout << "Toggle bits at pos 4-7" << std::endl;
