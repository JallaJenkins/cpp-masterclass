...
int main(){
  ...
  std::cout << "Red is: " << ((my_color & red_mask) >> 3*8) << std::endl;
  std::cout << "Green is: " << ((my_color & green_mask) >> 2*8) << std::endl;
  std::cout << "Blue is: " << ((my_color & blue_mask) >> 1*8) << std::endl;
  std::cout << "Alpha is: " << (my_color & alpha_mask) << std::endl;
