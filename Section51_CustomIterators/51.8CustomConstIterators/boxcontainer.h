...
public:
  ...
  public:
    ...
    Iterator& operator+=(const difference_type offset) {		//Required for random access functionality
			m_ptr += offset;
			return *this;
		}

		Iterator operator+(const difference_type offset) const {	//Required for random access functionality
			Iterator tmp = *this;
			return tmp += offset;
		}
		...
		difference_type operator-(const Iterator& right) const {	//Required for random access functionality
			return m_ptr - right.m_ptr;
		}

		reference_type operator[](const difference_type offset) const {	//Required for random access functionality
			return *(*this + offset);
		}

		bool operator<(const Iterator& right) const {				//Required for random access functionality
			return m_ptr < right.m_ptr;
		}
		...
		friend Iterator operator+(const difference_type offset, const Iterator it){	//Required for random access functionality
			Iterator tmp = it;
			return tmp += offset;
		}
  ...
  public:
    ...
    ConstIterator& operator+=(const difference_type offset) {		//Required for random access functionality
			m_ptr += offset;
			return *this;
		}

		ConstIterator operator+(const difference_type offset) const {	//Required for random access functionality
			Iterator tmp = *this;
			return tmp += offset;
		}
		...
		difference_type operator-(const ConstIterator& right) const {	//Required for random access functionality
			return m_ptr - right.m_ptr;
		}
		...
		bool operator<(const ConstIterator& right) const {				//Required for random access functionality
			return m_ptr < right.m_ptr;
		}
		...
		friend ConstIterator operator+(const difference_type offset, const ConstIterator it){	//Required for random access functionality
